...
export const Header: React.FC<HeaderProps> = React.memo(
  ({ soundEnabled = true, currentUnit, onSelectUnit }) => {
    ...
    return (
      <header
        className={`sticky top-0 z-50 px-4 py-2.5 transition-all duration-300 pointer-events-none ${
          scrolled
            ? 'bg-white/80 dark:bg-[#0A0A0B]/80 backdrop-blur-md border-b border-zinc-200 dark:border-white/10 shadow-sm'
            : ''
        }`}
      >
        <div className="w-full max-w-[1600px] mx-auto flex items-center justify-end pointer-events-auto">
          ...
          <div className="flex items-center gap-2">
            {/* The SaaS Vision button was removed */}
          </div>
        </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] font-semibold text-zinc-500 uppercase tracking-widest mt-0.5">
                          Target: $312M → $3B (India test-prep)
                        </p>
                      </div>
                    </div>
                    <button
                  ...
                  <div className="space-y-4 text-sm text-zinc-400 leading-relaxed">
                    <div className="bg-black/40 border border-white/5 p-4 rounded-2xl space-y-2">
                      ...
                      <p className="text-zinc-300">
                        Standard LLMs answer fast and sound confident even when wrong. In
                        competitive exams (JEE/NEET), losing 4 marks can theoretically shift a
                        student's college rank by thousands.
                      </p>
                    </div>
                    ...
                    <div className="bg-[#2563EB]/10 border border-[#2563EB]/30 p-4 rounded-2xl space-y-2">
                      ...
                      <p className="text-zinc-200 font-medium">
                        Two-pass architecture: Solver AI derives from NCERT text, while Critic AI
                        line-audits every step. If even 1 step is unbacked, we output a clear{' '}
                        <span className="font-bold text-[#F43F5E]">
                          "Do Not Trust / Ask Teacher"
                        </span>{' '}
                        warning.
                      </p>
                    </div>
