  ...
  return (
    <div className="pt-4 px-4 max-w-md md:max-w-2xl lg:max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-1 text-xs scrollbar-none">
        <span className="text-zinc-900 dark:text-zinc-50 opacity-80 font-semibold flex-shrink-0">
          Problem Vault:
        </span>
        {problems.map((p) => (
          <m.button
            ...
            >
              <div className="flex items-center justify-between border-b border-black/5 dark:border-white/5 pb-2">
                <h3 className="text-sm font-extrabold text-zinc-900 dark:text-zinc-50 uppercase tracking-wider flex items-center gap-2">
                  ...
                  {isFlipped
                    ? 'NCERT Conceptual Fact-Check'
                    : 'Original Question (Tap to Flip Concept Card)'}
                </h3>
            ...
            <div className="space-y-2">
              <m.button
                ...
                onClick={() => {
                  playSound('click', soundEnabled);
                  onNotify?.(
                    `Opening textbook source reference: ${activeProblem.reference.textbook}`,
                    'info',
                  );
                }}
